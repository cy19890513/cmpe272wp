...
class bctx_breadcrumb_trail
{
	...
	public function __construct()
	{
		...
		if(!is_textdomain_loaded('tx-breadcrumb'))
		{
			load_plugin_textdomain('tx-breadcrumb', false, 'tx-breadcrumb/languages');
		}
		...
		$this->opt = array(
			...
			'Hmainsite_template' => bctx_breadcrumb::get_default_template(),
			//The breadcrumb template for the main site, used when an anchor is not needed
			'Hmainsite_template_no_anchor' => bctx_breadcrumb::default_template_no_anchor,
			//Should the home page be shown
			'bhome_display' => true,
			//The breadcrumb template for the home page
			'Hhome_template' => bctx_breadcrumb::get_default_template(),
			//The breadcrumb template for the home page, used when an anchor is not needed
			'Hhome_template_no_anchor' => bctx_breadcrumb::default_template_no_anchor,
			...
			'Hpost_page_template' => bctx_breadcrumb::get_default_template(),
			//The anchor template for page breadcrumbs, used when an anchor is not needed
			'Hpost_page_template_no_anchor' => bctx_breadcrumb::default_template_no_anchor,
			//Just a link to the page on front property
			'apost_page_root' => get_option('page_on_front'),
			//Paged options
			//The template for paged breadcrumb
			'Hpaged_template' => __('<span property="itemListElement" typeof="ListItem"><span property="name">Page %htitle%</span><meta property="position" content="%position%"></span>', 'tx-breadcrumb'),
			...
			'Hpost_post_template' => bctx_breadcrumb::get_default_template(),
			//The breadcrumb template for post breadcrumbs, used when an anchor is not needed
			'Hpost_post_template_no_anchor' => bctx_breadcrumb::default_template_no_anchor,
			...
			'Hpost_attachment_template' => bctx_breadcrumb::get_default_template(),
			//The breadcrumb template for attachment breadcrumbs, used when an anchor is not needed
			'Hpost_attachment_template_no_anchor' => bctx_breadcrumb::default_template_no_anchor,
			//404 page settings
			//The template for 404 breadcrumbs
			'H404_template' => bctx_breadcrumb::default_template_no_anchor,
			//The text to be shown in the breadcrumb for a 404 page
			'S404_title' => __('404', 'tx-breadcrumb'),
			//Search page options
			//The breadcrumb template for search breadcrumbs
			'Hsearch_template' => __('<span property="itemListElement" typeof="ListItem"><span property="name">Search results for &#39;<a property="item" typeof="WebPage" title="Go to the first page of search results for %title%." href="%link%" class="%type%">%htitle%</a>&#39;</span><meta property="position" content="%position%"></span>', 'tx-breadcrumb'),
			//The breadcrumb template for search breadcrumbs, used when an anchor is not necessary
			'Hsearch_template_no_anchor' => __('<span property="itemListElement" typeof="ListItem"><span property="name">Search results for &#39;%htitle%&#39;</span><meta property="position" content="%position%"></span>', 'tx-breadcrumb'),
			//Tag related stuff
			//The breadcrumb template for tag breadcrumbs
			'Htax_post_tag_template' => __('<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to the %title% tag archives." href="%link%" class="%type%"><span property="name">%htitle%</span></a><meta property="position" content="%position%"></span>', 'tx-breadcrumb'),
			//The breadcrumb template for tag breadcrumbs, used when an anchor is not necessary
			'Htax_post_tag_template_no_anchor' => bctx_breadcrumb::default_template_no_anchor,
			//Post format related stuff
			//The breadcrumb template for post format breadcrumbs, used when an anchor is not necessary
			'Htax_post_format_template' => __('<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to the %title% archives." href="%link%" class="%type%"><span property="name">%htitle%</span></a><meta property="position" content="%position%"></span>', 'tx-breadcrumb'),
			//The breadcrumb template for post format breadcrumbs
			'Htax_post_format_template_no_anchor' => bctx_breadcrumb::default_template_no_anchor,
			//Author page stuff
			//The anchor template for author breadcrumbs
			'Hauthor_template' => __('<span property="itemListElement" typeof="ListItem"><span property="name">Articles by: <a title="Go to the first page of posts by %title%." href="%link%" class="%type%">%htitle%</a>', 'tx-breadcrumb'),
			//The anchor template for author breadcrumbs, used when anchors are not needed
			'Hauthor_template_no_anchor' => __('<span property="itemListElement" typeof="ListItem"><span property="name">Articles by: %htitle%</span><meta property="position" content="%position%"></span>', 'tx-breadcrumb'),
			...
			'Htax_category_template' => __('<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to the %title% category archives." href="%link%" class="%type%"><span property="name">%htitle%</span></a><meta property="position" content="%position%"></span>', 'tx-breadcrumb'),
			//The breadcrumb template for category breadcrumbs, used when anchors are not needed
			'Htax_category_template_no_anchor' => bctx_breadcrumb::default_template_no_anchor,
			//The breadcrumb template for date breadcrumbs
			'Hdate_template' => __('<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to the %title% archives." href="%link%" class="%type%"><span property="name">%htitle%</span></a><meta property="position" content="%position%"></span>', 'tx-breadcrumb'),
			//The breadcrumb template for date breadcrumbs, used when anchors are not needed
			'Hdate_template_no_anchor' => bctx_breadcrumb::default_template_no_anchor
		);
	}
	/**
	 * This returns the internal version
	 * 
	 * @deprecated 5.2.0 No longer needed, superceeded bctx_breadcrumb_trail::version
	 *
	 * @return string internal version of the Breadcrumb trail
	 */
	public function get_version()
	{
		_deprecated_function( __FUNCTION__, '5.2', 'bctx_breadcrumb_trail::version' );
		return self::version;
	}
	/**
	 * Adds a breadcrumb to the breadcrumb trail
	 * 
	 * @param bctx_breadcrumb $object Breadcrumb to add to the trail
	 * 
	 * @return pointer to the just added Breadcrumb
	 */
	public function &add(bctx_breadcrumb $object)
	{
	...
	protected function do_search($search_query, $is_paged = false)
	{
		...
		$breadcrumb = $this->add(new bctx_breadcrumb($search_query, $this->opt['Hsearch_template_no_anchor'], array('search', 'current-item')));
	...
	protected function do_author($author_data, $is_paged = false)
	{
		...
		{
			//Place the breadcrumb in the trail, uses the constructor to set the title, prefix, and suffix, get a pointer to it in return
			$breadcrumb = $this->add(new bctx_breadcrumb(get_the_author_meta($this->opt['Sauthor_name'], $author_data->ID), $this->opt['Hauthor_template_no_anchor'], array('author', 'current-item'), null, $author_data->ID));
			//If we're paged, or allowing the current item to be linked, let's link to the first page
			if($this->opt['bcurrent_item_linked'] || ($is_paged && $this->opt['bpaged_display']))
			{
	...
	protected function determine_taxonomy()
	{
		...
		$bctx_wp->public_query_vars = $wp->public_query_vars;
		$bctx_wp->parse_request();
		$_SERVER['REQUEST_URI'] = $bk_req;
		if(is_array($bctx_wp->query_vars))
		{
			foreach($bctx_wp->query_vars as $query_var => $value)
			{
	...
	protected function pick_post_term($id, $type, $taxonomy)
	{
		...
		$bctx_object = get_the_terms($id, $taxonomy);
		$potential_parent = 0;
		//Make sure we have an non-empty array
		if(is_array($bctx_object))
		{
			//Now try to find the deepest term of those that we know of
			$bctx_use_term = key($bctx_object);
			foreach($bctx_object as $key => $object)
			{
				//Can't use the next($bctx_object) trick since order is unknown
			...
			return $bctx_object[$bctx_use_term];
		}
		return false;
	}
	/**
		...
		if($this->opt['bpost_' . $type . '_hierarchy_display'])
		{
			...
			else
			{
				...
				if(is_taxonomy_hierarchical($taxonomy))
				{
					...
					$term = apply_filters('bctx_pick_post_term', $this->pick_post_term($id, $type, $taxonomy), $id, $type, $taxonomy);
	...
	protected function post_terms($id, $taxonomy)
	{
		...
		$bctx_terms = apply_filters('bctx_post_terms', get_the_terms($id, $taxonomy), $taxonomy, $id);
		//Only process if we have terms
		if(is_array($bctx_terms))
		{
			$title = '';	
			$is_first = true;
			//Loop through all of the term results
			foreach($bctx_terms as $term)
			{
			...
			$breadcrumb = $this->add(new bctx_breadcrumb($title, '%htitle%', array('taxonomy', $taxonomy)));
		}
	}
	/**
	 * A Breadcrumb Trail Filling Function
	...
	protected function term_parents($id, $taxonomy)
	{
		...
		{
			//Place the breadcrumb in the trail, uses the constructor to set the title, template, and type, get a pointer to it in return
			$breadcrumb = $this->add(new bctx_breadcrumb($term->name, $this->opt['Htax_' . $taxonomy . '_template'], array('taxonomy', $taxonomy), $this->maybe_add_post_type_arg(get_term_link($term), null, $taxonomy), $id));
	...
	protected function post_parents($id, $frontpage)
	{
		...
		$parent = get_post($id);
		//Place the breadcrumb in the trail, uses the constructor to set the title, template, and type, get a pointer to it in return
		$breadcrumb = $this->add(new bctx_breadcrumb(get_the_title($id), $this->opt['Hpost_' . $parent->post_type . '_template'], array('post', 'post-' . $parent->post_type), get_permalink($id), $id));
		//Make sure the id is valid, and that we won't end up spinning in a loop
	...
	protected function do_post($post, $force_link = false, $is_paged = false, $is_current_item = true)
	{
		...
		{
			_doing_it_wrong(__CLASS__ . '::' . __FUNCTION__, __('$post global is not of type WP_Post', 'tx-breadcrumb'), '5.1.1');
			return;
		}
		//Place the breadcrumb in the trail, uses the bctx_breadcrumb constructor to set the title, template, and type
		$breadcrumb = $this->add(new bctx_breadcrumb(get_the_title($post), $this->opt['Hpost_' . $post->post_type . '_template_no_anchor'], array('post', 'post-' . $post->post_type), null, $post->ID));
		if($is_current_item)
		{
	...
	{
		_deprecated_function( __FUNCTION__, '6.0', 'bctx_breadcrumb_trail::do_post');
	...
	{
		//Place the breadcrumb in the trail, uses the constructor to set the title, template, and type, get a pointer to it in return
		$breadcrumb = $this->add(new bctx_breadcrumb($term->name, $this->opt['Htax_' . $term->taxonomy . '_template_no_anchor'], array('archive', 'taxonomy', $term->taxonomy, 'current-item'), null, $term->term_id));
	...
	{
		//Place the breadcrumb in the trail, uses the constructor to set the title, prefix, and suffix, get a pointer to it in return
		$breadcrumb = $this->add(new bctx_breadcrumb(get_the_time(_x('d', 'day archive breadcrumb date format', 'tx-breadcrumb'), $post), $this->opt['Hdate_template_no_anchor'], array('archive', 'date-day')));
	...
	{
		//Place the breadcrumb in the trail, uses the constructor to set the title, prefix, and suffix, get a pointer to it in return
		$breadcrumb = $this->add(new bctx_breadcrumb(get_the_time(_x('F', 'month archive breadcrumb date format', 'tx-breadcrumb'), $post), $this->opt['Hdate_template_no_anchor'], array('archive', 'date-month')));
	...
	protected function do_year($post, $type, $is_paged = false, $is_current_item = true)
	{
		...
		$breadcrumb = $this->add(new bctx_breadcrumb(get_the_time(_x('Y', 'year archive breadcrumb date format', 'tx-breadcrumb'), $post), $this->opt['Hdate_template_no_anchor'], array('archive', 'date-year')));
	...
	{
		_deprecated_function( __FUNCTION__, '6.0', 'bctx_breadcrumb_trail::do_day, bctx_breadcrumb_trail::do_month, and/or bctx_breadcrumb_trail::do_year');
	...
	protected function do_archive_by_post_type($type_str, $is_paged = false)
	{
		...
		//Place the breadcrumb in the trail, uses the constructor to set the title, prefix, and suffix, get a pointer to it in return
		$breadcrumb = $this->add(new bctx_breadcrumb($title, $this->opt['Hpost_' . $type_str . '_template_no_anchor'], array('archive', 'post-' . $type_str . '-archive', 'current-item')));
		if($this->opt['bcurrent_item_linked'] || ($is_paged && $this->opt['bpaged_display']))
		{
	...
	protected function do_home($force_link = false, $is_paged = false, $is_current_item = true)
	{
		...
		//Place the breadcrumb in the trail, uses the constructor to set the title, prefix, and suffix, get a pointer to it in return
		$breadcrumb = $this->add(new bctx_breadcrumb($site_name, $this->opt['Hhome_template_no_anchor'], array('home')));
		if($is_current_item)
		{
			$breadcrumb->add_type('current-item');
		}
		...
		if($this->opt['bmainsite_display'] && !is_main_site())
		{
			...
			$breadcrumb = $this->add(new bctx_breadcrumb($site_name, $this->opt['Hmainsite_template'], array('main-home'), get_home_url($current_site->blog_id)));
		}
	}
	/**
	...
	protected function maybe_add_post_type_arg($url, $type = null, $taxonomy = null)
	{
		...
		if(apply_filters('bctx_add_post_type_arg', $add_query_arg, $type, $taxonomy))
		{
	...
	protected function type_archive($type, $type_str = false)
	{
		...
		{
			//Place the breadcrumb in the trail, uses the constructor to set the title, prefix, and suffix, get a pointer to it in return
			$breadcrumb = $this->add(new bctx_breadcrumb($this->post_type_archive_title(get_post_type_object($type_str)), $this->opt['Hpost_' . $type_str . '_template'], array('post', 'post-' . $type_str . '-archive'), get_post_type_archive_link($type_str)));
		}
			...
			&& !$this->is_type_query_var_array())
		{
			...
			$post_type = apply_filters('bctx_type_archive_post_type', $this->get_type_string_query_var($wp_taxonomies[$type->taxonomy]->object_type[0]));
			//Place the breadcrumb in the trail, uses the constructor to set the title, prefix, and suffix, get a pointer to it in return
			$breadcrumb = $this->add(new bctx_breadcrumb($this->post_type_archive_title(get_post_type_object($post_type)), $this->opt['Hpost_' . $post_type . '_template'], array('post', 'post-' . $post_type . '-archive'), get_post_type_archive_link($post_type)));
		}
	}
	/**
	 * A Breadcrumb Trail Filling Function 
	...
	protected function do_root($type_str, $root_id, $is_paged = false, $is_current_item = true)
	{
		...
		$bctx_post = get_post($root_id);
		//We'll have to check if this ID is valid, e.g. user has specified a posts page
		if($bctx_post instanceof WP_Post && $root_id > 0 && $root_id != $frontpage_id)
		{
			...
			$breadcrumb = $this->add(new bctx_breadcrumb(get_the_title($root_id), $this->opt['Hpost_' . $type_str . '_template_no_anchor'], array($type_str . '-root', 'post', 'post-' . $type_str), null, $root_id));
			...
			if($bctx_post->post_parent > 0 && $bctx_post->ID != $bctx_post->post_parent && $frontpage_id != $bctx_post->post_parent)
			{
				$this->post_parents($bctx_post->post_parent, $frontpage_id);
			}
		}
	}
	/**
	...
	{
		//Place the breadcrumb in the trail, uses the bctx_breadcrumb constructor to set the title, prefix, and suffix
		$this->breadcrumbs[] = new bctx_breadcrumb($this->opt['S404_title'], $this->opt['H404_template'], array('404', 'current-item'));
	}
	/**
	 * A Breadcrumb Trail Filling Function
	 * 
	...
	{
		//Place the breadcrumb in the trail, uses the bctx_breadcrumb constructor to set the title, prefix, and suffix
		$this->breadcrumbs[] = new bctx_breadcrumb((string) $page_number, $this->opt['Hpaged_template'], array('paged'));
	}
	/**
	...
	public function fill()
	{
		...
		do_action('bctx_before_fill', $this);
		...
		//Do any actions if necessary, we past through the current object instance to keep life simple
		do_action('bctx_after_fill', $this);
	}
	...
	{
		_deprecated_function( __FUNCTION__, '6.0', 'bctx_breadcrumb_trail::display');
	...
	protected function display_loop($linked, $reverse, $template)
	{
		...
		foreach($this->breadcrumbs as $key => $breadcrumb)
		{
			...
			$attribs = apply_filters_deprecated('bctx_li_attributes', array($class, $breadcrumb->get_types(), $breadcrumb->get_id()), '6.0.0', 'bctx_display_attributes');
			$attribs = apply_filters('bctx_display_attributes', $class, $breadcrumb->get_types(), $breadcrumb->get_id());
