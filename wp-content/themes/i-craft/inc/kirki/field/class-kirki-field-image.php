...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'i-craft' ),
				'change'       => esc_attr__( 'Change image', 'i-craft' ),
				'default'      => esc_attr__( 'Default', 'i-craft' ),
				'remove'       => esc_attr__( 'Remove', 'i-craft' ),
				'placeholder'  => esc_attr__( 'No image selected', 'i-craft' ),
				'frame_title'  => esc_attr__( 'Select image', 'i-craft' ),
				'frame_button' => esc_attr__( 'Choose image', 'i-craft' ),
			)
		);
	}
